...
- [nexu-io/open-design](https://github.com/xianyu110/open-design) - 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landin…（★ 88166；来源：dsh-plugin）[官网](https://open-design.ai/)
- [Q00/ouroboros](https://github.com/xianyu110/ouroboros) - Agent OS: the agent gets smarter on its own. We just hold the line: the grading command and expected result never make it into the success contract we hand it. Interview-gated, st…（★ 5502；来源：dsh-plugin + deepseek-harness）[官网](https://ouroboros.page/)
- [QCYTSN/dsh-dafeiyu](https://github.com/xianyu110/dsh-dafeiyu) - Desktop-native BigFish companion for DeepSeek Harness — real Agent status, always on top on Windows.（★ 102；来源：dsh-plugin）
- [lovstudio/yoda](https://github.com/xianyu110/yoda) - Yoda — master agentic coding through precise parallel orchestration of multiple coding agents（★ 68；来源：deepseek-harness）[官网](https://yoda.lovstudio.ai/)
- [Jia-520-only/Miya](https://github.com/xianyu110/Miya) - Miya,一个比较集成的智能体，可以接入各种类型的API，主要作用是提供拟人陪伴以及电脑操作，远程控制等，可以在多个平台交互，统一使用一个后端进程，没有新增的会话窗口，一切对话都会进入弥娅的记忆。（★ 31；来源：deepseek-harness）[官网](https://www.bilibili.com/video/BV1ef5R6HE2C/?share_source=copy_web&vd_source=7dd95f626c81cc377acd4cb7e01d234b)
- [N0zoM1z0/th08](https://github.com/xianyu110/th08) - Source reconstruction of Touhou Eiyashou (TH08) 1.00d（★ 29；来源：dsh-plugin）
- [whitelonng/dshcode](https://github.com/xianyu110/dshcode) - Community desktop companion for DeepSeek Harness — one-click Electron app for macOS and Windows（★ 28；来源：dsh-plugin）
- [snomiao/agent-yes](https://github.com/xianyu110/agent-yes) - Run AI coding agents (Claude, Codex, Gemini …) unattended — auto-answer prompts, auto-retry on rate limits, and list/tail/steer every agent locally or from agent-yes.com（★ 28；来源：deepseek-harness）[官网](https://agent-yes.com/)
- [kejixiaoliang/awesome-dsh-plugins](https://github.com/xianyu110/awesome-dsh-plugins-kejixiaoliang) - DeepSeek Harness (DSH) 插件精选目录 — 14 类 280+ 个社区插件，覆盖 MCP / Skill / TUI / 多 Agent / 上下文记忆 / UI 皮肤，点链接直达仓库。Curated directory of dsh plugins for DeepSeek Harness.（★ 20；来源：dsh-plugin）
- [cclank/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub-cclank) - DeepSeek Harness community plugin registry with evidence-based screening（★ 16；来源：deepseek-harness）[官网](https://dsh.lanshuagent.com/)
- [liguobao/deepseek-harness-remote](https://github.com/xianyu110/deepseek-harness-remote) - 基于 DeepSeek Harness 插件机制的多端远程访问方案，让桌面端与 Android 端安全连接并操作远程 Harness。（A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling desktop and Android…（★ 14；来源：dsh-plugin）
- [NoNameLeGo/dsh-catppuccin-theme](https://github.com/xianyu110/dsh-catppuccin-theme) - DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种主题一键切换，内置可开关的玻璃质感（Glassmorphism）（★ 10；来源：dsh-plugin）[官网](https://www.npmjs.com/package/@nonamelego/dsh-catppuccin)
- [helloHupc/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub-hellohupc) - DSH 插件聚合站:全网 DeepSeek Harness 插件聚合检索,多源自动去重分类,每小时刷新 | https://dsh-plugin-hub.hupc.site（★ 10；来源：deepseek-harness）
- [XMoon/dsh-pi-tui](https://github.com/xianyu110/dsh-pi-tui) - A third-party TUI mode for DeepSeek Harness (dsh), built on a vendored fork of pi-tui（★ 9；来源：dsh-plugin + deepseek-harness）
- [bpc-oss/dsh-web-billing](https://github.com/xianyu110/dsh-web-billing) - RMB/USD token-billing plugin for DeepSeek Harness (dsh web): official-policy auto pricing with peak/off-peak hours, per-message ledger, account balance, locale-driven currency dis…（★ 9；来源：dsh-plugin）
- [wxhou/openspec-playwright](https://github.com/xianyu110/openspec-playwright) - OpenSpec + Playwright Test Agents integration for automated E2E verification（★ 8；来源：deepseek-harness）[官网](https://wxhou.github.io/openspec-playwright/)
- [Player-MINEPIG/dsh-tavern](https://github.com/xianyu110/dsh-tavern) - A plugin which makes dsh compatible with SillyTavern artifacts.（★ 7；来源：dsh-plugin）
- [NANTI34/DEEPHARNESS](https://github.com/xianyu110/DEEPHARNESS) - DeepSeek Harness Windows desktop app - 换肤桌面快捷方式一键打开 AI 工作台应用 界面美化 功能集合（★ 7；来源：deepseek-harness）
- [kingOfSoySauce/dsh-skin-market](https://github.com/xianyu110/dsh-skin-market) - 未提供项目描述（★ 6；来源：dsh-plugin + deepseek-harness）
- [Ceelog/dsh-plugins](https://github.com/xianyu110/dsh-plugins-ceelog) - deepseek harness plugins（★ 6；来源：dsh-plugin + deepseek-harness）[官网](https://www.npmjs.com/package/@opendsh/dsh-plugin-scheduled-tasks)
