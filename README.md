...
- [amruthpillai/reactive-resume](https://github.com/xianyu110/reactive-resume) - A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!（★ 40819；来源：dsh-plugin）[官网](https://rxresu.me/)
- [raullenchai/Rapid-MLX](https://github.com/xianyu110/Rapid-MLX) - The fastest local AI engine for Apple Silicon. 4.2x faster than Ollama, 0.08s cached TTFT, 100% tool calling. 17 tool parsers, prompt cache, reasoning separation, cloud routing. D…（★ 3497；来源：deepseek-harness）[官网](https://pypi.org/project/rapid-mlx)
- [gmh5225/awesome-game-security](https://github.com/xianyu110/awesome-game-security) - awesome game security [Welcome to PR]（★ 3377；来源：deepseek-harness）[官网](https://gs.awesome.rip/)
- [edison7009/EchoBird](https://github.com/xianyu110/EchoBird) - One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI)…（★ 3063；来源：dsh-plugin + deepseek-harness）[官网](https://echobird.ai/)
- [Anil-matcha/awesome-dsh-plugin](https://github.com/xianyu110/awesome-dsh-plugin-anil-matcha) - A curated list of plugins for DeepSeek Harness (dsh) - DeepSeek Harness plugin ecosystem（★ 929；来源：dsh-plugin）
- [hairyf/deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop-hairyf) - DeepSeek Harness Tauri 桌面版 | Only 5mb installer, zero environment setup. Windows / macOS / Linux.（★ 421；来源：dsh-plugin）
- [nutshellai-tech/mobius](https://github.com/xianyu110/mobius) - The first self-evolving open-source Agent OS, connecting your team, AI agents, devices, and compute（★ 284；来源：dsh-plugin）[官网](https://nutshellai-tech.github.io/mobius/)
- [cocofhu/anime-find](https://github.com/xianyu110/anime-find) - DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Bangumi 评分与详情，支持复制磁力。（★ 136；来源：dsh-plugin）
- [AITabby/dockyard-dsh](https://github.com/xianyu110/dockyard-dsh) - A macOS-only native account-pool and provider plugin for DeepSeek Harness.（★ 57；来源：dsh-plugin）
- [ZASENJC/dsh-plugins-store](https://github.com/xianyu110/dsh-plugins-store) - 自动分类、收录和验证 DeepSeek-Harness 社区插件的市场。 Automatically categorize, curate, and validate the DeepSeek-Harness community plugin marketplace.（★ 56；来源：dsh-plugin + deepseek-harness）[官网](https://dshmk.com/)
- [like-study1/Oh-My-DSH](https://github.com/xianyu110/Oh-My-DSH-like-study1) - 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic（★ 56；来源：dsh-plugin + deepseek-harness）[官网](https://like-study1.github.io/Oh-My-DSH/)
- [morluto/jacobian](https://github.com/xianyu110/jacobian) - Pure mathematics for agents: search for examples and counterexamples, compute exactly, and independently check what a result proves.（★ 52；来源：dsh-plugin）
- [fwerkor/local-shell-mcp](https://github.com/xianyu110/local-shell-mcp) - Enables LLM to use a cli environment.（★ 49；来源：dsh-plugin + deepseek-harness）[官网](https://fwerkor.github.io/local-shell-mcp/)
- [whyihaveyou/dsh-suite](https://github.com/xianyu110/dsh-suite) - The living DeepSeek Harness plugin directory — refreshed hourly, compat-tested daily, with an in-app plugin store and scaffolder. DSH 插件活目录：每小时刷新，每日兼容实测，内置插件商店与脚手架。（★ 38；来源：dsh-plugin + deepseek-harness）[官网](https://whyihaveyou.github.io/dsh-suite/)
- [opencues/opencues](https://github.com/xianyu110/opencues) - Turn any text field into a two-way LLM channel: it reads what you write and fills what you ask. Flags a slip as you type, answers anything you end with _. Claude Code, OpenCode, G…（★ 33；来源：dsh-plugin）[官网](https://www.opencues.com/)
- [834063245-creator/HoloGram](https://github.com/xianyu110/HoloGram) - 3D code dependency graph generator with built-in LLM agent. Language-agnostic (Python, TypeScript, Rust, Go, Java, C/C++, C#, Ruby, Kotlin, Swift, PHP, Lua). Coupling depth analys…（★ 24；来源：dsh-plugin + deepseek-harness）
- [PlutoKeating/dsh-lark-bot](https://github.com/xianyu110/dsh-lark-bot) - dsh-lark-bot：把 DeepSeek Harness (dsh) 桥接进飞书/Lark 的 bot，扫码即用：流式卡片、项目工作区、并行任务、多角色 Agent、跨会话通知、对话内模型/密钥管理与安全网守护（dsh 崩溃后飞书仍可自救）。A scan-to-connect bridge bot connecting DeepSeek Harnes…（★ 21；来源：dsh-plugin）[官网](https://dshfind.com/zh/plugins/PlutoKeating/dsh-lark-bot)
- [YELEBAI/dsh-plugin-marketplace](https://github.com/xianyu110/dsh-plugin-marketplace) - Verified plugin marketplace and autonomous registry for DeepSeek Harness（★ 20；来源：dsh-plugin + deepseek-harness）
- [Ericwong5021/deepseek-plugin-store](https://github.com/xianyu110/deepseek-plugin-store) - DeepSeek Harness 独立社区插件商店：发现、安装并提交经过验证的插件、工具与扩展。 | Independent community plugin directory.（★ 20；来源：dsh-plugin）[官网](https://deepseekplugin.store/)
