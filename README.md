...
- [multica-ai/multica](https://github.com/xianyu110/multica) - Assign issues to Claude Code, Codex, Cursor, and 17 more coding agents like teammates — open-source and self-hostable.（★ 46578；来源：deepseek-harness）[官网](https://multica.ai/)
- [Devin-AXIS/iPolloWork](https://github.com/xianyu110/iPolloWork) - A next-generation, source-available AI workspace with a self-evolving agent runtime for editable code, design, presentations, websites, and video—a Codex alternative that integrat…（★ 4136；来源：dsh-plugin）[官网](https://www.ipollo.ai/)
- [Anionex/agent-vision-toolkit](https://github.com/xianyu110/agent-vision-toolkit) - 为纯文本模型"看图“设计更好的视觉工具箱和技能，支持多图理解，图片问答，前端UI还原、GUI 自动化等，并可选无缝接入多个主流agent，直接识别粘贴图片｜ A vision toolkit and skill designed for text-only llms — image Q&A, long-screenshot OCR, frontend UI…（★ 1017；来源：dsh-plugin + deepseek-harness）[官网](https://agent-vision.anionex.me/)
- [alibaba/anolisa](https://github.com/xianyu110/anolisa) - ANOLISA (Agentic Nexus Operating Layer & Interface System Architecture) | Agentic OS with runtime, security, observability, and Tokenless response compression for lower token usag…（★ 353；来源：dsh-plugin）[官网](https://agentic-os.sh/)
- [zhaoolee/notes](https://github.com/xianyu110/notes) - 开源版锤子便签，复刻锤科美学，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片（★ 146；来源：dsh-plugin）[官网](https://notes.fangyuanxiaozhan.com/)
- [bradeGithub/DSH-Plugins-Marketplace](https://github.com/xianyu110/DSH-Plugins-Marketplace) - DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 | browse, install & update all GitHub dsh-plugin plugins in the DSH Web GUI（★ 120；来源：dsh-plugin + deepseek-harness）
- [MaimoryLab/BootAgent](https://github.com/xianyu110/BootAgent) - BootAgent is a local management tool of AI agents. It turns a fresh machine into a usable, repeatable setup without asking you to edit several tool-specific config files by hand.（★ 91；来源：deepseek-harness）[官网](https://bootagent.ai/)
- [toolclub/dsh-agent-team-gui](https://github.com/xianyu110/dsh-agent-team-gui) - Persistent multi-model workflow teams for DeepSeek Harness — dynamic lead planning, bounded DAGs, per-agent model/tools, Run Center and Token insights.（★ 40；来源：dsh-plugin）
- [zimodzh/dsh-plugin-dev-skills](https://github.com/xianyu110/dsh-plugin-dev-skills) - An Agent Skills skill for developing DeepSeek Harness (DSH) plugins（开发 DSH 插件的 Agent Skill）——插件/服务/事件/工具/LLM 适配器/打包安装的标准。Works with Claude Code, Codex, DSH, VS Code Copilot & any …（★ 34；来源：dsh-plugin + deepseek-harness）
...
- [Tyan66666/billion-context-dsh](https://github.com/xianyu110/billion-context-dsh) - Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to compress. Ported from billion-context-pi (ranxianglei)…（★ 24；来源：dsh-plugin + deepseek-harness）[官网](https://www.npmjs.com/package/billion-context-dsh)
- [kingOfSoySauce/dsh-skin-market](https://github.com/xianyu110/dsh-skin-market) - 未提供项目描述（★ 19；来源：dsh-plugin + deepseek-harness）
- [DDDMUC/dsh-free-search](https://github.com/xianyu110/dsh-free-search) - Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed（★ 15；来源：dsh-plugin + deepseek-harness）
- [WSL043/dsh-codex-subscription](https://github.com/xianyu110/dsh-codex-subscription) - 在 DeepSeek Harness 中直接使用 ChatGPT/Codex 订阅，无需 OpenAI API Key 或 Codex CLI，支持 OAuth 登录、订阅搜索与额度显示 | ChatGPT/Codex subscription plugin for DSH（★ 11；来源：dsh-plugin）[官网](https://www.npmjs.com/package/dsh-codex-subscription)
- [helloHupc/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub-hellohupc) - DSH 插件聚合站:全网 DeepSeek Harness 插件聚合检索,多源自动去重分类,每小时刷新 | https://dsh-plugin-hub.hupc.site（★ 11；来源：deepseek-harness）
- [bpc-oss/dsh-web-billing](https://github.com/xianyu110/dsh-web-billing) - RMB/USD token-billing plugin for DeepSeek Harness (dsh web): official-policy auto pricing with peak/off-peak hours, per-message ledger, account balance, locale-driven currency dis…（★ 10；来源：dsh-plugin + deepseek-harness）
- [Rianico/dsh-better-edit](https://github.com/xianyu110/dsh-better-edit) - Hash-anchored read/edit/batch_edit/undo_last_edit tools for DeepSeek Harness (dsh) — dsh port of pi-hashline-edit-lsz（★ 9；来源：dsh-plugin + deepseek-harness）
- [linny006/prompt-tools-live](https://github.com/xianyu110/prompt-tools-live) - Live-updating tracker of prompt engineering tools, libraries, and techniques — refreshed every 15 mi（★ 9；来源：deepseek-harness）
...
- [a903067276-rgb/dsh-hud](https://github.com/xianyu110/dsh-hud) - HUD status panel plugin for DeepSeek Harness (dsh) web: git status, MCP servers, skills, model & token usage in a floating panel（★ 7；来源：dsh-plugin）
