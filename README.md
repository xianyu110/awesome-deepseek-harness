...
- [Hmbown/CodeWhale](https://github.com/xianyu110/CodeWhale) - Open-source, community-driven agent harness（★ 40821；来源：deepseek-harness）[官网](https://codewhale.net/)
- [ctxrs/ctx](https://github.com/xianyu110/ctx) - Instant recall for coding agents. Search the history already on your machine. Git blame, but for agent sessions.（★ 1031；来源：deepseek-harness）[官网](https://ctx.rs/)
- [PC2005-cloud/dsh-pet](https://github.com/xianyu110/dsh-pet) - DSH 桌面宠物：一行命令安装现成宠物（28 个透明动画，即装即用），或内置素材链从 AI 视频自造专属宠物 | One-line install desktop pet for DeepSeek Harness + DIY asset pipeline（★ 59；来源：dsh-plugin）
- [beancookie/awesome-dsh-plugin](https://github.com/xianyu110/awesome-dsh-plugin-beancookie) - Awesome DeepSeek Harness (DSH) Plugin（★ 50；来源：dsh-plugin + deepseek-harness）[官网](https://beancookie.github.io/awesome-dsh-plugin/)
- [AITabby/dockyard-dsh](https://github.com/xianyu110/dockyard-dsh) - A macOS-only native account-pool and provider plugin for DeepSeek Harness.（★ 29；来源：dsh-plugin + deepseek-harness）
- [sperictao/codex-pro-max](https://github.com/xianyu110/codex-pro-max) - Codex Pro Max — Tauri v2 desktop launcher: taskboard service management, Codex CDP panel injection, ~/.codex config guard, FastCtx MCP integration, DeepSeek Harness remote access,…（★ 29；来源：deepseek-harness）
- [openguardrails/openguardrails](https://github.com/xianyu110/openguardrails) - The vendor-neutral protocol for AI agent safety & security — and the neutral benchmark that ranks the vendors.（★ 27；来源：dsh-plugin）[官网](https://openguardrails.com/)
- [1102tools/federal-contracting-skills](https://github.com/xianyu110/federal-contracting-skills) - Free universal agent skills for federal contracting: SOW/PWS builder, three IGCE builders (FFP, LH/T&M, cost-reimbursement), OT project description, and OT cost analysis. Portable…（★ 25；来源：deepseek-harness）[官网](https://1102tools.com/)
...
- [2BingLing/dsh-market](https://github.com/xianyu110/dsh-market-2bingling) - DeepSeek Harness 插件市场 · 持续收录 1500+ DSH 插件：中文搜索 + 实用五维评分 + 一键安装。Web 版与 DSH 侧边栏插件双形态。Plugin marketplace for DeepSeek Harness: 1500+ plugins, Chinese search, 5-dim scoring, one-click…（★ 16；来源：dsh-plugin）[官网](https://dsh.market/)
- [1102tools/federal-contracting-mcps](https://github.com/xianyu110/federal-contracting-mcps) - Eight free MCP servers for federal contracting data and policy tracking. SAM.gov, USASpending, GSA CALC+, BLS OEWS, GSA Per Diem, eCFR, Federal Register, Regulations.gov. 124 dete…（★ 16；来源：deepseek-harness）
- [Fishsb/dsh-prompt-enhancer](https://github.com/xianyu110/dsh-prompt-enhancer) - DeepSeek Harness DSH 提示词增强插件：✨ 一键优化草稿，增强提示词。（★ 11；来源：dsh-plugin + deepseek-harness）
- [ZK-Andy/dsh-continual-evolve](https://github.com/xianyu110/dsh-continual-evolve) - Continual self-evolution plugin for DeepSeek Harness: versioned, auditable, rollback-safe harness state refined from session trajectories, with a benchmark-driven validation loop.（★ 9；来源：dsh-plugin）
- [BlockRunAI/dsh-clawrouter](https://github.com/xianyu110/dsh-clawrouter) - A safety gate for DeepSeek Harness: a stronger model reviews dangerous tool calls before they run. Plus vision and 67 models from one wallet, paid per request over x402.（★ 9；来源：dsh-plugin）[官网](https://www.npmjs.com/package/dsh-clawrouter)
- [KCNyu/clawock](https://github.com/xianyu110/clawock) - AI argues. Code settles. The losses stay on the page. A real HK + US brokerage account run by agents that must debate every call, settled by code the model never touches. Install …（★ 9；来源：dsh-plugin）[官网](https://kcnyu.github.io/clawock/)
...
- [helloHupc/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub-hellohupc) - DSH 插件聚合站:全网 DeepSeek Harness 插件聚合检索,多源自动去重分类,每小时刷新 | https://dsh-plugin-hub.hupc.site（★ 9；来源：deepseek-harness）
- [Tkingxiao/dsh-any-background](https://github.com/xianyu110/dsh-any-background) - 一个自定义主题插件，包括背景图（大小和位置），主界面和设置界面（透明度，色轮全色主题色）插件（★ 8；来源：dsh-plugin + deepseek-harness）
...
- [WSL043/dsh-codex-subscription](https://github.com/xianyu110/dsh-codex-subscription) - 在 DeepSeek Harness 中直接使用 ChatGPT/Codex 订阅，无需 OpenAI API Key 或 Codex CLI，支持 OAuth 登录、订阅搜索与额度显示 | ChatGPT/Codex subscription plugin for DSH（★ 7；来源：dsh-plugin + deepseek-harness）
