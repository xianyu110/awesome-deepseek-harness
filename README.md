...
- [ollama/ollama](https://github.com/xianyu110/ollama) - Get up and running with Kimi-K2.6, GLM-5.2, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models.（★ 179055；来源：deepseek-harness）[官网](https://ollama.com/)
- [Q00/ouroboros](https://github.com/xianyu110/ouroboros) - Agent OS: the agent gets smarter on its own. We just hold the line: the grading command and expected result never make it into the success contract we hand it. Interview-gated, st…（★ 5591；来源：dsh-plugin + deepseek-harness）[官网](https://ouroboros.page/)
- [huangruiteng/loopx](https://github.com/xianyu110/loopx) - Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses.（★ 4979；来源：deepseek-harness）[官网](https://my.feishu.cn/wiki/CaL5wMk9ui17ngkWzeUcMlAYnZg)
- [raullenchai/Rapid-MLX](https://github.com/xianyu110/Rapid-MLX) - The fastest local AI engine for Apple Silicon. 4.2x faster than Ollama, 0.08s cached TTFT, 100% tool calling. 17 tool parsers, prompt cache, reasoning separation, cloud routing. D…（★ 3518；来源：deepseek-harness）[官网](https://pypi.org/project/rapid-mlx)
- [AntigmaLabs/ante](https://github.com/xianyu110/ante) - Ghost in your shell. Ante is a self-contained agent harness with a highly optimized core. It works like Claude Code or Codex, with none of their dependencies or model constraints.（★ 1826；来源：deepseek-harness）[官网](https://antigma.ai/)
- [numtide/llm-agents.nix](https://github.com/xianyu110/llm-agents.nix) - Nix packages for AI coding agents and development tools. Automatically updated daily.（★ 1786；来源：deepseek-harness）
- [vivekchand/clawmetry](https://github.com/xianyu110/clawmetry) - See your agent think. Zero-config observability & governance for 20+ AI agent runtimes: OpenClaw, Claude Code, OpenAI Codex, Cursor, Aider, Goose, NVIDIA NemoClaw, NanoClaw & more…（★ 398；来源：deepseek-harness）[官网](https://clawmetry.com/)
- [shuangji66/FnDepot](https://github.com/xianyu110/FnDepot) - Fndepot商店仓库源（★ 189；来源：deepseek-harness）
- [omdsh-dev/dsh-mnemon](https://github.com/xianyu110/dsh-mnemon) - Three-tier memory control plane for DeepSeek Harness: persistent runtime context, searchable project documents, pluggable long-term memory, smart routing, supervised agent workflo…（★ 138；来源：dsh-plugin + deepseek-harness）
- [bradeGithub/DSH-Plugins-Marketplace](https://github.com/xianyu110/DSH-Plugins-Marketplace) - DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 | browse, install & update all GitHub dsh-plugin plugins in the DSH Web GUI（★ 129；来源：dsh-plugin + deepseek-harness）
- [xmanrui/dsh-im](https://github.com/xianyu110/dsh-im) - 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、企业微信、QQ、Slack、Telegram、Discord和WhatsApp）。 Connect IM bots to DeepSeek Harness via QR code or credentials (9 channels).（★ 103；来源：dsh-plugin）
- [like-study1/Oh-My-DSH](https://github.com/xianyu110/Oh-My-DSH-like-study1) - 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic（★ 68；来源：dsh-plugin）[官网](https://like-study1.github.io/Oh-My-DSH/)
- [Vladimir-Human/ru-marketplace-mcp](https://github.com/xianyu110/ru-marketplace-mcp) - Одиннадцать маркетплейсов как MCP-серверы: Wildberries, Ozon, Яндекс Маркет, Детский мир, Авито, AliExpress, Taobao, Мегамаркет, Lamoda, DNS, Ситилинк. Плюс сравнение цен по всем …（★ 66；来源：dsh-plugin）
- [JingbiaoMei/Tokdash](https://github.com/xianyu110/Tokdash) - Agent Dashboard: Visualization and analytics for Sessions and Quota Usage. Track, analyze, and optimize token usage across providers with heatmaps, cost tracking, token counting a…（★ 60；来源：dsh-plugin）[官网](https://tokdash.github.io/)
- [the911fund/skill-of-skills](https://github.com/xianyu110/skill-of-skills) - The autonomous discovery engine for AI coding tools. Indexes skills, plugins, MCP servers, agents, and integrations across Claude Code, Codex, Gemini CLI, and more.（★ 34；来源：deepseek-harness）[官网](https://skills.911fund.io/)
...
- [kejixiaoliang/awesome-dsh-plugins](https://github.com/xianyu110/awesome-dsh-plugins-kejixiaoliang) - DeepSeek Harness (DSH) 插件精选目录 — 14 类 280+ 个社区插件，覆盖 MCP / Skill / TUI / 多 Agent / 上下文记忆 / UI 皮肤，点链接直达仓库。Curated directory of dsh plugins for DeepSeek Harness.（★ 23；来源：dsh-plugin + deepseek-harness）
- [Mai0313/VibeCodingTracker](https://github.com/xianyu110/VibeCodingTracker) - Track AI coding costs in real-time — a lightweight Rust CLI/TUI for Claude Code, Codex, Copilot & Gemini usage and cost analytics（★ 13；来源：deepseek-harness）[官网](https://mai0313.github.io/VibeCodingTracker/)
- [helloHupc/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub-hellohupc) - DSH 插件聚合站:全网 DeepSeek Harness 插件聚合检索,多源自动去重分类,每小时刷新 | https://dsh-plugin-hub.hupc.site（★ 12；来源：deepseek-harness）
- [Karbo123/DSH-EvoResearch](https://github.com/xianyu110/DSH-EvoResearch) - 自进化科研工作流（★ 10；来源：dsh-plugin）
