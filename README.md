...
- [nexu-io/open-design](https://github.com/xianyu110/open-design) - 🎨 The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landing pages, dashboards, slides, images &…（★ 86752；来源：dsh-plugin）[官网](https://open-design.ai/)
- [Ikalus1988/MisakaNet](https://github.com/xianyu110/MisakaNet) - 📚 A zero-dependency, git-backed micro-lesson library for AI Agents to asynchronously share and search verified debugging experience. Python stdlib only. | https://misakanet.org（★ 410；来源：dsh-plugin）[官网](https://misakanet.org/)
- [bradeGithub/DSH-Plugins-Marketplace](https://github.com/xianyu110/DSH-Plugins-Marketplace) - DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 | browse, install & update all GitHub dsh-plugin plugins in the DSH Web GUI（★ 65；来源：dsh-plugin）
- [xiincs/deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop-xiincs) - DeepSeek Harness 原生桌面版，基于 Tauri 2，内置 Node.js 运行时，一键安装，极速启动，托盘常驻，自动更新。DeepSeek Harness native desktop version: built on Tauri 2 with a bundled Node.js runtime.（★ 36；来源：deepseek-harness）
- [like-study1/Oh-My-DSH](https://github.com/xianyu110/Oh-My-DSH-like-study1) - 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic（★ 31；来源：dsh-plugin）[官网](https://like-study1.github.io/Oh-My-DSH/)
- [zuorn/Tydora](https://github.com/xianyu110/Tydora) - Let Your Ideas Flow — Tydora is a modern desktop Markdown editor combining WYSIWYG editing, bidirectional links, mind maps, and an infinite canvas — empowering deep thinking and e…（★ 24；来源：dsh-plugin）[官网](https://zuorn.github.io/Tydora/)
- [linny006/skills-tracker](https://github.com/xianyu110/skills-tracker) - Real-time tracking of every new GitHub 'skills' repo to capture the AI agent skill ecosystem trend（★ 17；来源：deepseek-harness）
- [kejixiaoliang/awesome-dsh-plugins](https://github.com/xianyu110/awesome-dsh-plugins-kejixiaoliang) - DeepSeek Harness (DSH) 插件精选目录 — 14 类 280+ 个社区插件，覆盖 MCP / Skill / TUI / 多 Agent / 上下文记忆 / UI 皮肤，点链接直达仓库。Curated directory of dsh plugins for DeepSeek Harness.（★ 12；来源：dsh-plugin + deepseek-harness）
- [Tyan66666/billion-context-dsh](https://github.com/xianyu110/billion-context-dsh) - Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to compress. Ported from billion-context-pi (ranxianglei)…（★ 12；来源：dsh-plugin）[官网](https://www.npmjs.com/package/billion-context-dsh)
...
- [SenmuuuuW/dsh-whale-report](https://github.com/xianyu110/dsh-whale-report) - 🐋 鲸鱼记事本 — 你的 Agent 年度报告：从会话事件日志生成日报/周报/月报/年报，任意区间、只读不改写（★ 11；来源：dsh-plugin）
- [lire1131/dsh-undo-plugin](https://github.com/xianyu110/dsh-undo-plugin) - DSH plugin: snapshot & rollback your DSH configs AND user-plugin code files, with crash attribution and one-click SAFE MODE. Auto-save on change, undo/redo stack, snapshot manager…（★ 9；来源：dsh-plugin + deepseek-harness）
...
- [zhijun-dai/Catppuccin-dsh-theme](https://github.com/xianyu110/Catppuccin-dsh-theme) - 🐱 Soothing pastel theme for DeepSeek Harness（★ 5；来源：dsh-plugin）[官网](https://www.npmjs.com/package/dsh-catppuccin)
- [csyyywy/dsh-desktop](https://github.com/xianyu110/dsh-desktop-csyyywy) - DeepSeek Harness 桌面封装：本地一键安装/启动/更新 dsh 的 Electron 外壳（壳核分离，不破坏扩展性）（★ 5；来源：deepseek-harness）
- [loadingvx/deepseek-harness-workbench-plugin](https://github.com/xianyu110/deepseek-harness-workbench-plugin) - Deepseek-harness-workbench-plugin（★ 5；来源：deepseek-harness）[官网](https://www.npmjs.com/package/dsh-workbench-plugin)
- [labmimors/dsh-mcp-lens](https://github.com/xianyu110/dsh-mcp-lens) - Shrink MCP schema overhead in DeepSeek Harness: 1,000 remote tools behind 2 exact-schema interfaces, plus a local calculator and CI budget Action.（★ 4；来源：dsh-plugin + deepseek-harness）[官网](https://labmimors.github.io/dsh-mcp-lens/)
- [Fishsb/dsh-prompt-enhancer](https://github.com/xianyu110/dsh-prompt-enhancer) - DeepSeek Harness DSH 提示词增强插件：✨ 一键优化草稿，增强提示词。（★ 4；来源：dsh-plugin）
- [zh667/TokenLedger](https://github.com/xianyu110/TokenLedger) - Relay-site attributed token usage for DeepSeek Harness — zero config, no credentials（★ 3；来源：dsh-plugin + deepseek-harness）[官网](https://www.npmjs.com/package/dsh-tokenledger)
