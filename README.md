...
- [nexu-io/open-design](https://github.com/xianyu110/open-design) - 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landin…（★ 89945；来源：dsh-plugin + deepseek-harness）[官网](https://open-design.ai/)
- [wanshuiyin/Auto-claude-code-research-in-sleep](https://github.com/xianyu110/Auto-claude-code-research-in-sleep) - ARIS ⚔️ (Auto-Research-In-Sleep) — Lightweight Markdown-only skills for autonomous ML research: cross-model review loops, idea discovery, and experiment automation. No framework, …（★ 14968；来源：deepseek-harness）
- [MemTensor/MemOS](https://github.com/xianyu110/MemOS) - Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% token savings and DeepSeek Harness support.（★ 10866；来源：dsh-plugin）[官网](https://memos.openmem.net/)
- [alibaba/anolisa](https://github.com/xianyu110/anolisa) - ANOLISA (Agentic Nexus Operating Layer & Interface System Architecture) | Agentic OS with runtime, security, observability, and Tokenless response compression for lower token usag…（★ 370；来源：dsh-plugin）[官网](https://agentic-os.sh/)
- [xmanrui/dsh-im](https://github.com/xianyu110/dsh-im) - 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、企业微信、QQ、Slack、Telegram、Discord和WhatsApp）。 Connect IM bots to DeepSeek Harness via QR code or credentials (9 channels).（★ 297；来源：dsh-plugin）
- [lbx154/Argus](https://github.com/xianyu110/Argus) - A self-evolving multi-agent system for autonomous research, operating 24/7 to explore, learn, and improve.（★ 272；来源：deepseek-harness）
- [yjh051108/dsh-super-injector](https://github.com/xianyu110/dsh-super-injector) - 未提供项目描述（★ 130；来源：dsh-plugin）
- [beancookie/awesome-dsh-plugin](https://github.com/xianyu110/awesome-dsh-plugin-beancookie) - Awesome DeepSeek Harness (DSH) Plugin（★ 94；来源：dsh-plugin）[官网](https://beancookie.github.io/awesome-dsh-plugin/)
- [like-study1/Oh-My-DSH](https://github.com/xianyu110/Oh-My-DSH-like-study1) - 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic（★ 68；来源：dsh-plugin + deepseek-harness）[官网](https://like-study1.github.io/Oh-My-DSH/)
- [seriousz158/dsh-memory](https://github.com/xianyu110/dsh-memory-seriousz158) - 未提供项目描述（★ 52；来源：dsh-plugin + deepseek-harness）
- [Francis-Xavier-code/dsh-balance-plugin](https://github.com/xianyu110/dsh-balance-plugin) - deepSeek 余额监控与用量统计（DSH 动态 Cordis 插件）：余额监控 · 官方充值入口 · 用量统计 · 三方插件管理（★ 52；来源：dsh-plugin）
- [EverMind-AI/SkillCorpus](https://github.com/xianyu110/SkillCorpus) - Open-source infrastructure that turns scattered SKILL.md files into curated, retrieval-ready agent-skill corpora—with retrieval and evaluation tooling included.（★ 48；来源：deepseek-harness）[官网](https://evermind.ai/skillhub)
- [skymecode/deepseek-harness-for-vscode](https://github.com/xianyu110/deepseek-harness-for-vscode) - deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback!（★ 40；来源：dsh-plugin + deepseek-harness）[官网](https://marketplace.visualstudio.com/items?itemName=skymecode.deepseek-harness-for-vscode)
- [modusensus/dsh-mneme](https://github.com/xianyu110/dsh-mneme) - Structured memory engine for DeepSeek Harness. Offline semantic search, entity-attribute-timeline, autoDream self-consolidation, and human-editable Markdown storage.（★ 30；来源：dsh-plugin + deepseek-harness）[官网](https://www.npmjs.com/package/@modusensus/dsh-mneme)
- [ChenRuoT/dsh-sidebar-qa](https://github.com/xianyu110/dsh-sidebar-qa) - 一个基于DSH-better-sidebar的侧边栏提问tab，实现类codex的侧边提问或claude code的/btw功能（★ 30；来源：dsh-plugin）
- [WEP-56/DSH-Launcher](https://github.com/xianyu110/DSH-Launcher-wep-56) - deepseek harness的启动器，非webui二次打包而是webui内嵌，可以适配所有webui强化插件。额外提供dsh包管理、配置文件管理、插件管理、浏览器标签页、多窗口等功能（★ 25；来源：dsh-plugin + deepseek-harness）
- [web-casa/DeepSeek-Harness-Desktop](https://github.com/xianyu110/DeepSeek-Harness-Desktop-web-casa) - Native desktop packaging of DeepSeek Harness (DSH) for Windows & macOS — no Node.js setup required. 将 DeepSeek Harness（DSH）打包为 Windows/macOS 原生桌面应用，无需配置 Node.js。（★ 25；来源：deepseek-harness）
- [Zephyr-vibe/dsh-archived-sessions](https://github.com/xianyu110/dsh-archived-sessions) - DSH Session Manager: manage conversations, archive/restore, delete safely, open record folders.（★ 17；来源：dsh-plugin）
- [flizzywine/dsh-tavern](https://github.com/xianyu110/dsh-tavern-flizzywine) - 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。（★ 17；来源：dsh-plugin）
- [isomoes/ikanban](https://github.com/xianyu110/ikanban) - iKanban 是一个面向键盘操作、基于 DeepSeek Harness 的多智能体编码工作空间。它专为跨项目地驱动、审查和协调并行智能体工作而构建，将会话管理、差异审查和项目感知导航集于一处。（★ 12；来源：dsh-plugin）[官网](https://www.npmjs.com/package/@isomoes/dsh-ikanban)
