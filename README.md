...
- [Alishahryar1/free-claude-code](https://github.com/xianyu110/free-claude-code) - Use Claude Code, Codex, Pi, and OpenCode for free (1.3B+ free tokens) from your terminal, app, IDE, or phone like OpenClaw (voice supported + ToS friendly)（★ 46314；来源：deepseek-harness）
- [esengine/DeepSeek-Reasonix](https://github.com/xianyu110/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.（★ 34952；来源：dsh-plugin）[官网](http://reasonix.io/)
- [kenn-io/agentsview](https://github.com/xianyu110/agentsview) - Local-first session search, analytics, insights, and token use statistics for coding agents, supporting Claude Code, Codex, and more than 20 other agents.（★ 5167；来源：deepseek-harness）[官网](https://agentsview.io/)
...
- [duanyytop/agents-radar](https://github.com/xianyu110/agents-radar) - Daily AI ecosystem digest from 10 sources (GitHub, ArXiv, HN, HuggingFace, Product Hunt, Dev.to, Lobste.rs). Bilingual ZH/EN reports via GitHub Actions.（★ 963；来源：deepseek-harness）[官网](https://duanyytop.github.io/agents-radar)
...
- [leenkcool/Blue-Whale-Harness](https://github.com/xianyu110/Blue-Whale-Harness) - DeepSeek-Harness-Plugins（★ 156；来源：deepseek-harness）
- [beancookie/awesome-dsh-plugin](https://github.com/xianyu110/awesome-dsh-plugin-beancookie) - Awesome DeepSeek Harness (DSH) Plugin（★ 94；来源：dsh-plugin + deepseek-harness）[官网](https://beancookie.github.io/awesome-dsh-plugin/)
- [shaftoe/awesome-pi-coding-agent](https://github.com/xianyu110/awesome-pi-coding-agent) - An auto-discovered, LLM curated directory of resources for the Pi Coding Agent ecosystem. Updated daily.（★ 89；来源：deepseek-harness）[官网](https://awesome-pi.site/)
...
- [Noob-stupid/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub) - DeepSeek Harness (DSH) 插件管理面板：一键启用/停用插件 + GitHub dsh-plugin 插件市场，带插件详情与一键安装 | Plugin manager & marketplace for DeepSeek Harness（★ 62；来源：dsh-plugin）
...
- [TheodoreGalanos/aec-bench](https://github.com/xianyu110/aec-bench) - 未提供项目描述（★ 35；来源：deepseek-harness）
...
- [fakechris/dsh-harness-ops](https://github.com/xianyu110/dsh-harness-ops) - DSH 运维工具箱：升级、重启、故障都不用操心。① 官方每日快照 A/B 双槽轮换——旧插件迁移+构建+验收全过才原子切换，一键回滚，旧版本永远兜底；② 守护 10s 自动拉起 web + agent 断点自动续接，重启无人值守；③ web 全挂（A/B 都坏、agent 不可用）时 dsh-doctor 一条命令自救：九项诊断→机械修复配置→LLM 深度…（★ 11；来源：dsh-plugin + deepseek-harness）
- [KCNyu/clawock](https://github.com/xianyu110/clawock) - AI argues. Code settles. The losses stay on the page. A real HK + US brokerage account run by agents that must debate every call, settled by code the model never touches. Install …（★ 10；来源：dsh-plugin）[官网](https://kcnyu.github.io/clawock/)
- [siegfly/dsh-deepseek-vision](https://github.com/xianyu110/dsh-deepseek-vision) - Vision-language gateway plugin for DeepSeek Harness - paste an image, DeepSeek sees text（★ 7；来源：dsh-plugin + deepseek-harness）
