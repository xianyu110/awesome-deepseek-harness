...
- [Alishahryar1/free-claude-code](https://github.com/xianyu110/free-claude-code) - Use Claude Code, Codex, Pi, and OpenCode for free (1.3B+ free tokens) from your terminal, app, IDE, or phone like OpenClaw (voice supported + ToS friendly)（★ 46305；来源：deepseek-harness）
- [esengine/DeepSeek-Reasonix](https://github.com/xianyu110/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.（★ 34948；来源：dsh-plugin）[官网](http://reasonix.io/)
- [gmh5225/awesome-game-security](https://github.com/xianyu110/awesome-game-security) - awesome game security [Welcome to PR]（★ 3397；来源：deepseek-harness）[官网](https://gs.awesome.rip/)
- [edison7009/EchoBird](https://github.com/xianyu110/EchoBird) - One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI)…（★ 3097；来源：dsh-plugin）[官网](https://echobird.ai/)
- [WEIFENG2333/phistory](https://github.com/xianyu110/phistory) - Phistory automatically archives versioned system prompt snapshots from agent CLIs like Claude Code, Codex, OpenClaw, and Hermes.（★ 549；来源：deepseek-harness）[官网](https://phistory.cc/)
- [Ikalus1988/MisakaNet](https://github.com/xianyu110/MisakaNet) - 📚 A zero-dependency, git-backed micro-lesson library for AI Agents to asynchronously share and search verified debugging experience. Python stdlib only. | https://misakanet.org（★ 415；来源：dsh-plugin + deepseek-harness）[官网](https://misakanet.org/)
...
- [HarnessRouter/harnessrouter](https://github.com/xianyu110/harnessrouter) - HarnessRouter Community Edition: the self-hosted, Apache-2.0 edition of the unified interface for agent harnesses. Run Codex, Claude Code, Hermes, and more through one API, with s…（★ 334；来源：deepseek-harness）[官网](https://harnessrouter.ai/)
- [Noob-stupid/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub) - DeepSeek Harness (DSH) 插件管理面板：一键启用/停用插件 + GitHub dsh-plugin 插件市场，带插件详情与一键安装 | Plugin manager & marketplace for DeepSeek Harness（★ 62；来源：dsh-plugin + deepseek-harness）
- [ZASENJC/dsh-plugins-store](https://github.com/xianyu110/dsh-plugins-store) - 自动分类、收录和验证 DeepSeek-Harness 社区插件的市场。 Automatically categorize, curate, and validate the DeepSeek-Harness community plugin marketplace.（★ 62；来源：dsh-plugin + deepseek-harness）[官网](https://dshmk.com/)
- [nagi-studio/nagi-bench](https://github.com/xianyu110/nagi-bench) - One-shot LLM eval cases by NAGI STUDIO - same prompt, different agents (model + harness), runnable artifacts side by side.（★ 57；来源：deepseek-harness）[官网](http://bench.nagi.fun/)
- [morluto/jacobian](https://github.com/xianyu110/jacobian) - A universal, atomic library of mathematics and tools for agents to compose them.（★ 55；来源：dsh-plugin）
- [vlln/dsh-navbar](https://github.com/xianyu110/dsh-navbar) - DSH 插件：对话节点导航条（右缘节点串快速跳转 user 消息）。官方 bundle 插件，dsh plugin --profile web add 安装（★ 50；来源：dsh-plugin）
- [xlabs-club/awesome-x-ops](https://github.com/xianyu110/awesome-x-ops) - A curated map of modern X-Ops: AI Ops, LLM/Agent Observability, Platform Engineering, GitOps, DataOps, FinOps, DevSecOps, and production-grade open-source operations tooling.面向现代 …（★ 43；来源：deepseek-harness）
- [whyihaveyou/dsh-suite](https://github.com/xianyu110/dsh-suite) - The living DeepSeek Harness plugin directory — refreshed hourly, compat-tested daily, with an in-app plugin store and scaffolder. DSH 插件活目录：每小时刷新，每日兼容实测，内置插件商店与脚手架。（★ 42；来源：dsh-plugin + deepseek-harness）[官网](https://whyihaveyou.github.io/dsh-suite/)
- [Nyasers/dsh-hanako](https://github.com/xianyu110/dsh-hanako) - DSH for Hanako（★ 32；来源：dsh-plugin）
...
- [being1943/my_rss_reader](https://github.com/xianyu110/my_rss_reader) - Rss每日更新推送到邮箱（★ 11；来源：deepseek-harness）
- [KCNyu/clawock](https://github.com/xianyu110/clawock) - AI argues. Code settles. The losses stay on the page. A real HK + US brokerage account run by agents that must debate every call, settled by code the model never touches. Install …（★ 10；来源：dsh-plugin + deepseek-harness）[官网](https://kcnyu.github.io/clawock/)
- [diegosouzapw/awesome-omni-dsh-plugins](https://github.com/xianyu110/awesome-omni-dsh-plugins) - Unofficial community catalog for DeepSeek Harness plugins.（★ 9；来源：deepseek-harness）
