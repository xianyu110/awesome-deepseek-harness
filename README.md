...
- [nexu-io/open-design](https://github.com/xianyu110/open-design) - 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landin…（★ 88324；来源：dsh-plugin + deepseek-harness）[官网](https://open-design.ai/)
- [esengine/DeepSeek-Reasonix](https://github.com/xianyu110/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.（★ 34683；来源：dsh-plugin）[官网](http://reasonix.io/)
- [ccch1mneyyy/working-activity](https://github.com/xianyu110/working-activity) - Lively Working-line extension for pi CLI and DSH（★ 649；来源：dsh-plugin）
- [Nagi-ovo/dsh-ads](https://github.com/xianyu110/dsh-ads) - 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups for the DSH Web UI（★ 482；来源：dsh-plugin）
- [maojindao55/freebuddy](https://github.com/xianyu110/freebuddy) - FreeBuddy: desktop chat workspace for local CLI agents (codex / claude / opencode)（★ 143；来源：deepseek-harness）
- [Dominic789654/awesome-deepseek-harness](https://github.com/xianyu110/awesome-deepseek-harness-dominic789654) - A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators & UIs for DeepSeek Harness (DSH). Visualization · PPT · Coding · Agents · Loops (auto-research)…（★ 123；来源：dsh-plugin）
- [ChisaAlter/Deepseek-Harness-Desktop](https://github.com/xianyu110/Deepseek-Harness-Desktop-chisaalter) - DSH桌面端，支持主题和背景图等多种个性化配置。Electron desktop shell for DeepSeek Harness web UI（★ 110；来源：dsh-plugin + deepseek-harness）
- [Han-1413141/dsh-cost-meter](https://github.com/xianyu110/dsh-cost-meter) - DeepSeek Harness Session Cost Statistics & OpenCode Go Quota Display, DS Official Balance Display, Codex-like Token Heatmap Plugin: Current Session Cost, Daily Cost, Budget Limit …（★ 71；来源：dsh-plugin + deepseek-harness）
- [kelai141/dsh-mobile-apk](https://github.com/xianyu110/dsh-mobile-apk) - dsh 安卓壳 APK——WebView UI + 内嵌 Termux 运行时快照（解压即跑）、SAF 目录桥、保活服务、看门狗、运行时在线更新。（★ 67；来源：dsh-plugin）
- [THEWOLFWALKER/dsh-notifier](https://github.com/xianyu110/dsh-notifier) - Unified notification push plugin for DeepSeek Harness (DSH): one minimal notify() API, 8 channel adapters (telegram/dingtalk/feishu/wxpusher/pushplus/serverchan/bark/webhook), dua…（★ 37；来源：dsh-plugin）
- [openma-ai/deepseek-harness-tui](https://github.com/xianyu110/deepseek-harness-tui) - Self-Improvement TUI Plugin of DeepSeek Harness. dsh-tui（★ 36；来源：dsh-plugin）
- [lencx/Minke](https://github.com/xianyu110/Minke) - 🐳 DeepSeek Harness Desktop（★ 34；来源：dsh-plugin）
- [PerryLink/dsh-auto-review](https://github.com/xianyu110/dsh-auto-review) - Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny verdicts with reasons, fail-closed by default, full…（★ 27；来源：dsh-plugin）[官网](https://www.npmjs.com/package/dsh-auto-review)
- [zhu168/dsh-save-money](https://github.com/xianyu110/dsh-save-money) - Save-money plugin for DSH (DeepSeek Harness) — define your own "pause / resume" time windows; at pause time running long tasks are paused (not stopped) automatically, and they res…（★ 23；来源：dsh-plugin）
...
- [Laplace-bit/dsh-smooth-stream](https://github.com/xianyu110/dsh-smooth-stream) - DeepSeek Harness (dsh) plugin: silky streaming reveal, no flicker. dsh 丝滑流式渲染插件。（★ 21；来源：dsh-plugin + deepseek-harness）[官网](https://laplace-bit.github.io/dsh-smooth-stream/)
...
- [Fishsb/dsh-prompt-enhancer](https://github.com/xianyu110/dsh-prompt-enhancer) - DeepSeek Harness DSH 提示词增强插件：✨ 一键优化草稿，增强提示词。（★ 17；来源：dsh-plugin）
- [FuRongJun-1999/dsh-memory](https://github.com/xianyu110/dsh-memory) - AGI 的长期记忆基础设施。让 AI Agent 拥有不可遗忘的自我。跨会话记忆 · 持续学习 · 可审计信任（智能论 v3.2）（★ 15；来源：dsh-plugin）
