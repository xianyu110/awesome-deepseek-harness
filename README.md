...
- [junhoyeo/tokscale](https://github.com/xianyu110/tokscale) - 🛰️ Track token usage across AI coding agents from your terminal. 🏅 Global leaderboard with trillions of tokens tracked.（★ 5077；来源：deepseek-harness）[官网](https://tokscale.ai/)
- [raullenchai/Rapid-MLX](https://github.com/xianyu110/Rapid-MLX) - The fastest local AI engine for Apple Silicon. 4.2x faster than Ollama, 0.08s cached TTFT, 100% tool calling. 17 tool parsers, prompt cache, reasoning separation, cloud routing. D…（★ 3519；来源：deepseek-harness）[官网](https://pypi.org/project/rapid-mlx)
- [Ikalus1988/MisakaNet](https://github.com/xianyu110/MisakaNet) - 📚 A zero-dependency, git-backed micro-lesson library for AI Agents to asynchronously share and search verified debugging experience. Python stdlib only. | https://misakanet.org（★ 415；来源：dsh-plugin）[官网](https://misakanet.org/)
- [Dominic789654/awesome-deepseek-harness](https://github.com/xianyu110/awesome-deepseek-harness-dominic789654) - A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators & UIs for DeepSeek Harness (DSH). Visualization · PPT · Coding · Agents · Loops (auto-research)…（★ 172；来源：dsh-plugin）
- [askie/grix](https://github.com/xianyu110/grix) - Grix : Talk to agents like people.（★ 119；来源：deepseek-harness）[官网](https://grix.im/)
- [erbanku/awesome](https://github.com/xianyu110/awesome) - 🌟 My Awesome Repositories List. Automatically updates by GitHub Actions on UTC 00:00 & 16:00（★ 89；来源：deepseek-harness）
- [Nyasers/dsh-hanako](https://github.com/xianyu110/dsh-hanako) - DSH for Hanako（★ 32；来源：dsh-plugin + deepseek-harness）
...
- [web-casa/DeepSeek-Harness-Desktop](https://github.com/xianyu110/DeepSeek-Harness-Desktop-web-casa) - Native desktop packaging of DeepSeek Harness (DSH) for Windows & macOS — no Node.js setup required. 将 DeepSeek Harness（DSH）打包为 Windows/macOS 原生桌面应用，无需配置 Node.js。（★ 23；来源：deepseek-harness）
- [QAInsights/awesome-ai-tools](https://github.com/xianyu110/awesome-ai-tools-qainsights) - A curated, categorized reference of AI-powered coding tools. Covers full IDEs, editor extensions, terminal agents, autonomous agents, browser-based builders, and code review platf…（★ 22；来源：deepseek-harness）[官网](https://ai.dosa.dev/)
...
- [XMoon/dsh-pi-tui](https://github.com/xianyu110/dsh-pi-tui) - A third-party TUI mode for DeepSeek Harness (dsh), built on a vendored fork of pi-tui（★ 11；来源：dsh-plugin + deepseek-harness）
- [LBurny/deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop-lburny) - Windows desktop shell for DeepSeek's agent harness CLI (dsh). The installer bundles Node.js and dsh, so the official Web UI runs as a native app with tray, notifications, and them…（★ 10；来源：dsh-plugin + deepseek-harness）
- [a903067276-rgb/dsh-hud](https://github.com/xianyu110/dsh-hud) - HUD status panel plugin for DeepSeek Harness (dsh) web: git status, MCP servers, skills, model & token usage in a floating panel（★ 9；来源：dsh-plugin）
- [jiezeng2004-design/dsh-chatgpt-bridge](https://github.com/xianyu110/dsh-chatgpt-bridge) - MCP bridge that lets ChatGPT web create, view, continue, and control DeepSeek Harness (DSH) agent sessions.（★ 9；来源：dsh-plugin）
- [Airmetro/dsh-update-checker](https://github.com/xianyu110/dsh-update-checker) - 全栈更新管理：对 DeepSeek Harness 主程序与每个已装第三方插件做 npm/GitHub 双源 semver 比对，GUI 横幅随系统语言（中/英）提示可更新插件；一键更新主程序或任意插件，自动备份可回滚，更新后看门狗自动重启服务。Whole-stack update management for DeepSeek Harness: dual…（★ 8；来源：dsh-plugin + deepseek-harness）
