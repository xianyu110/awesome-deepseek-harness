...
- [Devin-AXIS/iPolloWork](https://github.com/xianyu110/iPolloWork) - Enterprise-grade, local-first Agent Workbench for people and agent teams. A unified multi-engine workspace for Codex Harness, DeepSeek Harness, and OpenCode, with unified plugins …（★ 4447；来源：dsh-plugin + deepseek-harness）[官网](https://www.ipollo.ai/)
- [edison7009/EchoBird](https://github.com/xianyu110/EchoBird) - One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI)…（★ 3109；来源：dsh-plugin）[官网](https://echobird.ai/)
- [whiteguo233/OpenBiliClaw](https://github.com/xianyu110/OpenBiliClaw) - 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent…（★ 2978；来源：dsh-plugin）[官网](https://whiteguo233.github.io/OpenBiliClaw/)
- [hairyf/deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop-hairyf) - DeepSeek Harness Tauri 桌面版 | Only 5mb installer, zero environment setup, preset plugins, Windows / macOS / Linux.（★ 860；来源：dsh-plugin）
- [Ikalus1988/MisakaNet](https://github.com/xianyu110/MisakaNet) - 📚 A zero-dependency, git-backed micro-lesson library for AI Agents to asynchronously share and search verified debugging experience. Python stdlib only. | https://misakanet.org（★ 421；来源：dsh-plugin + deepseek-harness）[官网](https://misakanet.org/)
- [libukai/awesome-deepseek-harness](https://github.com/xianyu110/awesome-deepseek-harness-libukai) - DeepSeek Harness 终极指南：快速入门、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit（★ 182；来源：dsh-plugin）[官网](https://x.com/libukai)
- [zhaoolee/notes](https://github.com/xianyu110/notes) - 开源版锤子便签，复刻锤科美学，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片（★ 149；来源：dsh-plugin + deepseek-harness）[官网](https://notes.fangyuanxiaozhan.com/)
...
- [omdsh-dev/dsh-annotation](https://github.com/xianyu110/dsh-annotation) - DSH Web 选中批注插件：选文字→批注→回车随消息发送；气泡隐藏批注块（零闪烁）；回复按 Annotation N 逐条对照（可悬浮芯片）。官方 bundle，零核心改动（★ 87；来源：dsh-plugin）[官网](https://omdsh-dev.github.io/dsh-annotation/)
- [Totoro-qaq/dsh-plugin-bridge](https://github.com/xianyu110/dsh-plugin-bridge) - DeepSeek Harness plugin for previewable cross-preset session migration. Fixed-schema handoffs preserve state, source-model intent, and unresolved images; the original session stay…（★ 76；来源：dsh-plugin）
...
- [Noob-stupid/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub) - DeepSeek Harness (DSH) 插件管理面板：一键启用/停用插件 + GitHub dsh-plugin 插件市场，带插件详情与一键安装 | Plugin manager & marketplace for DeepSeek Harness（★ 66；来源：dsh-plugin + deepseek-harness）
- [dream-num/dsh-univer-office](https://github.com/xianyu110/dsh-univer-office) - Preview, create, edit office spreadsheets, docs & slides inside DeepSeek Harness. Power by Univer.（★ 63；来源：dsh-plugin）[官网](https://univer.ai/)
- [Fishsb/dsh-prompt-enhancer](https://github.com/xianyu110/dsh-prompt-enhancer) - DeepSeek Harness (DSH) 插件：✨ 提示词一键增强 + 💬 语音识别（说完自动停·云端/本地双引擎）· 附 🔁 服务异常一键重启（★ 41；来源：dsh-plugin）
- [linny006/trending-claude-skills](https://github.com/xianyu110/trending-claude-skills) - Auto-updated leaderboard of trending claude-skills and AI agent repos, refreshed every 15 minutes（★ 32；来源：deepseek-harness）
- [UNLINEARITY/dsh-code](https://github.com/xianyu110/dsh-code) - Claude-Code-style TUI bundle for DeepSeek Harness. 充分结合 DSH 的核心机制和高级特性与Codex CLI 、Claude Code 等主流交互机制，打造的 DSH-Code. （对齐DSH官方上游最新版本！持续更新中！支持DSH 特殊模式，插件系统，模型管理，子代理管理，切换模型特殊动画）（★ 27；来源：dsh-plugin）
- [linny006/awesome-agent-skills](https://github.com/xianyu110/awesome-agent-skills) - Curated, auto-updated awesome-list of vetted AI agent skills with quality ratings for Claude, GPT, a（★ 25；来源：deepseek-harness）
- [hyqibot/DeepSeek-Harness-Token-Free](https://github.com/xianyu110/DeepSeek-Harness-Token-Free) - A token-free desktop client for the DeepSeek Harness，enjoy！为 DeepSeek Harness (DSH) 生态打造的全免Token费的桌面端 ，极简极易。内置多模态+顶尖工具链能力的大模型 HYQi（Flash / Image / Video）：生图+生视频均免token费，无需API， 有疑问…（★ 24；来源：dsh-plugin）[官网](https://hyqibot.com/)
