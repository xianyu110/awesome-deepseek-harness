...
- [esengine/DeepSeek-Reasonix](https://github.com/xianyu110/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.（★ 35047；来源：dsh-plugin）[官网](http://reasonix.io/)
- [duolahypercho/codex-router](https://github.com/xianyu110/codex-router) - External-model router for Codex with guided Kimi OAuth/API, DeepSeek, safe migration, and rollback.（★ 2768；来源：deepseek-harness）
- [zilliztech/memsearch](https://github.com/xianyu110/memsearch) - A persistent, unified memory layer for all your AI agents (e.g. Claude Code, Codex), backed by Markdown and Milvus.（★ 2494；来源：deepseek-harness）[官网](https://zilliztech.github.io/memsearch/)
- [xiufengsun/TokenTracker](https://github.com/xianyu110/TokenTracker) - Local-first AI token usage & cost tracker for 31 coding tools incl. Claude Code, Codex, Cursor, Gemini & DeepSeek Harness—with native apps. Never reads prompts.（★ 1403；来源：deepseek-harness）[官网](https://www.tokentracker.cc/)
- [zouyuxuan122/Deepseek-Harness-EAC](https://github.com/xianyu110/Deepseek-Harness-EAC) - DeepSeek Harness Desktop (dsh-desktop). EAC: Embracing All Creation (揽尽万象). Bundled Node.js runtime with full dsh-CLI kernel, one-click startup, 10 built-in UI themes.（★ 1149；来源：deepseek-harness）
- [uhub/awesome-chatgpt](https://github.com/xianyu110/awesome-chatgpt-uhub) - A curated list of awesome ChatGPT related projects.（★ 823；来源：deepseek-harness）
- [vshulcz/deja-vu](https://github.com/xianyu110/deja-vu) - Memory for coding agents. Indexes the sessions 20 agents already wrote to disk, including months from before you installed it, and recalls them in any of them. No LLM, no embeddin…（★ 656；来源：dsh-plugin）[官网](https://vshulcz.github.io/deja-vu/)
- [xiaods/k8e](https://github.com/xianyu110/k8e) - k8e.sh - OpenSource Agentic AI Sandbox Matrix（★ 478；来源：dsh-plugin + deepseek-harness）[官网](https://k8e.sh/)
- [Dominic789654/awesome-deepseek-harness](https://github.com/xianyu110/awesome-deepseek-harness-dominic789654) - A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators & UIs for DeepSeek Harness (DSH). Visualization · PPT · Coding · Agents · Loops (auto-research)…（★ 181；来源：dsh-plugin）
- [codex-radar/dradar](https://github.com/xianyu110/dradar) - 未提供项目描述（★ 134；来源：deepseek-harness）
- [beancookie/awesome-dsh-plugin](https://github.com/xianyu110/awesome-dsh-plugin-beancookie) - Awesome DeepSeek Harness (DSH) Plugin（★ 102；来源：dsh-plugin）[官网](https://beancookie.github.io/awesome-dsh-plugin/)
...
- [Noob-stupid/dsh-plugin-hub](https://github.com/xianyu110/dsh-plugin-hub) - DeepSeek Harness (DSH) 插件管理面板：一键启用/停用插件 + GitHub dsh-plugin 插件市场，带插件详情与一键安装 | Plugin manager & marketplace for DeepSeek Harness（★ 67；来源：dsh-plugin）
- [btspoony/mstar-harness](https://github.com/xianyu110/mstar-harness) - An omni-plugin for harness engineering workflows with multi-agents, programmatic gates and skills.（★ 52；来源：dsh-plugin + deepseek-harness）
- [christiandoxa/prodex](https://github.com/xianyu110/prodex) - Prodex is a multi-account, multi-provider Codex wrapper with auto-rotation, Super mode, Smart Context, and token saving for Codex CLI and Claude Code（★ 45；来源：deepseek-harness）
- [Renzic-Stone/DSH-EasyRewrite](https://github.com/xianyu110/DSH-EasyRewrite) - DSH Web内目前最无感的消息撤回、重编辑插件，原版体验，兼容性强，功能简单可开关，设置丰富，现代化轻量ui框架。The most seamless message recall & re-edit plugin for DSH Web — native experience, strong compatibility, simple toggles, …（★ 41；来源：dsh-plugin + deepseek-harness）
- [skyf0xx/hedgehog](https://github.com/xianyu110/hedgehog) - HEDGEHOG codes Cleaner, Faster and with Fewer Tokens. Hedgehog's AI-driven development builds a task dependency graph from your spec-driven, BMAD-METHOD plan, so Claude Code, Curs…（★ 29；来源：dsh-plugin + deepseek-harness）
