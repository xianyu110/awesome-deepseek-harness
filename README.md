...
- [nexu-io/open-design](https://github.com/xianyu110/open-design) - 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landin…（★ 88601；来源：dsh-plugin + deepseek-harness）[官网](https://open-design.ai/)
- [volcengine/OpenViking](https://github.com/xianyu110/OpenViking) - Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skills.（★ 28977；来源：dsh-plugin）[官网](https://openviking.ai/)
- [dsh-market/dsh-market](https://github.com/xianyu110/dsh-market) - The plugin market inside DeepSeek Harness — browse, search, one-click install · DSH 可视化插件市场（★ 931；来源：dsh-plugin + deepseek-harness）[官网](https://dshmarket.com/)
- [zouyuxuan122/Deepseek-Harness-EAC](https://github.com/xianyu110/Deepseek-Harness-EAC) - DeepSeek Harness (dsh) Windows / Linux desktop client - bundled Node.js + dsh CLI, one-click launch, 10 built-in UI skins. EAC: Embracing All Creation 揽尽万象（★ 805；来源：deepseek-harness）
- [ysr666/dsh-vision-router](https://github.com/xianyu110/dsh-vision-router) - Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&A, grounding, crop, pixel diff, colors, OCR, SVG trace, cutout, scree…（★ 698；来源：dsh-plugin + deepseek-harness）
...
- [Ariestar/sivtr](https://github.com/xianyu110/sivtr) - A unified agent memory workspace for human and agent（★ 135；来源：dsh-plugin）[官网](https://sivtr.pages.dev/)
- [QCYTSN/dsh-dafeiyu](https://github.com/xianyu110/dsh-dafeiyu) - Desktop-native BigFish companion for DeepSeek Harness — real Agent status, always on top on Windows.（★ 124；来源：dsh-plugin + deepseek-harness）
- [Han-1413141/dsh-cost-meter](https://github.com/xianyu110/dsh-cost-meter) - DeepSeek Harness Session Cost Statistics & OpenCode Go Quota Display, DS Official Balance & Custom Provider Balance Lookup, Codex-like Token Heatmap Plugin: Session/Daily Cost, Bu…（★ 88；来源：dsh-plugin + deepseek-harness）
- [mishibeikejie/zat-dsh-engine](https://github.com/xianyu110/zat-dsh-engine) - Visual plugin marketplace for DeepSeek Harness — browse, search and install community plugins（★ 70；来源：dsh-plugin）
- [bruc3van/dsh-desktop](https://github.com/xianyu110/dsh-desktop-bruc3van) - 让 Agent 安全常驻桌面的独立 dsh 客户端：官方 Web UI 原封不动，长任务常驻托盘，精选插件先审查、再安装。Independent dsh desktop client: the official Web UI untouched, long tasks alive in the tray, curated plugins reviewed …（★ 56；来源：dsh-plugin + deepseek-harness）[官网](https://x.com/bruc3van)
- [xiincs/deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop-xiincs) - DeepSeek Harness 原生桌面版，基于 Tauri 2，内置 Node.js 运行时，一键安装，极速启动，托盘常驻，自动更新。DeepSeek Harness native desktop version: built on Tauri 2 with a bundled Node.js runtime.（★ 40；来源：dsh-plugin）
- [openma-ai/deepseek-harness-tui](https://github.com/xianyu110/deepseek-harness-tui) - Self-Improvement TUI Plugin of DeepSeek Harness. dsh-tui（★ 38；来源：dsh-plugin）
- [Viy1204/recruiting-copilot](https://github.com/xianyu110/recruiting-copilot) - 给 HR / 猎头的 AI 招聘工作流：岗位标准梳理、Boss直聘 + 猎聘双通道寻源初筛、市场人才盘点、简历评估、约面试、候选人台账与日报。可装成 Claude Code 插件或 DeepSeek Harness (dsh) 插件——后者自带可直接上手操作的「招聘浏览器」面板；也能配合任意读 AGENTS.md 的 AI 编程助手使用。（★ 36；来源：dsh-plugin）
- [N0zoM1z0/th08](https://github.com/xianyu110/th08) - Source reconstruction of Touhou Eiyashou (TH08) 1.00d（★ 30；来源：dsh-plugin）
...
- [Kihara777/NixKits](https://github.com/xianyu110/NixKits) - 软件、补丁、NixOS 模块与 AI 编码助手的技能合集。（★ 23；来源：deepseek-harness）
- [techysy/deepseek-harness-fnos](https://github.com/xianyu110/deepseek-harness-fnos) - DeepSeek Harness (DeepSeek 官方 agent 浏览器 UI) fnOS 应用 — 本地常驻服务（★ 13；来源：dsh-plugin + deepseek-harness）
