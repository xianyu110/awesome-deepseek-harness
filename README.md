...
- [Devin-AXIS/iPolloWork](https://github.com/xianyu110/iPolloWork) - A next-generation, source-available AI workspace with a self-evolving agent runtime for editable code, design, presentations, websites, and video—a Codex alternative that integrat…（★ 4063；来源：dsh-plugin + deepseek-harness）[官网](https://www.ipollo.ai/)
- [strukto-ai/mirage](https://github.com/xianyu110/mirage) - The World's First Unified Virtual Filesystem For AI Agents（★ 3482；来源：dsh-plugin + deepseek-harness）[官网](https://www.strukto.ai/mirage)
- [xiufengsun/TokenTracker](https://github.com/xianyu110/TokenTracker) - Local-first AI token usage & cost tracker for 31 coding tools incl. Claude Code, Codex, Cursor, Gemini & DeepSeek Harness—with native apps. Never reads prompts.（★ 1339；来源：deepseek-harness）[官网](https://www.tokentracker.cc/)
- [dataelement/dsh-desktop](https://github.com/xianyu110/dsh-desktop-dataelement) - Desktop app for DeepSeek Harness（★ 620；来源：deepseek-harness）
- [ysr666/dsh-vision-router](https://github.com/xianyu110/dsh-vision-router) - Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&A, grounding, crop, pixel diff, colors, OCR, SVG trace, cutout, scree…（★ 495；来源：dsh-plugin + deepseek-harness）
- [xiaods/k8e](https://github.com/xianyu110/k8e) - k8e.sh - OpenSource Agentic AI Sandbox Matrix（★ 471；来源：dsh-plugin）[官网](https://k8e.sh/)
- [hairyf/deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop-hairyf) - DeepSeek Harness Tauri 桌面版 | Only 5mb installer, zero environment setup. Windows / macOS / Linux.（★ 326；来源：dsh-plugin + deepseek-harness）
- [Dominic789654/awesome-deepseek-harness](https://github.com/xianyu110/awesome-deepseek-harness-dominic789654) - A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators & UIs for DeepSeek Harness (DSH). Visualization · PPT · Coding · Agents · Loops (auto-research)…（★ 100；来源：dsh-plugin + deepseek-harness）
- [Devin-AXIS/deepseek-design](https://github.com/xianyu110/deepseek-design) - DeepSeek Harness 可编辑设计系统：AI 生成、可视化编辑、模板市场与 PPT｜Native Design & PPT Studio for DeepSeek Harness.（★ 71；来源：dsh-plugin + deepseek-harness）
- [Tabbit-Browser/dsh-plugin](https://github.com/xianyu110/dsh-plugin) - Tabbit Broser plugins for Deepseek Harness（★ 63；来源：dsh-plugin）[官网](https://www.tabbit.ai/)
...
- [modusensus/dsh-mneme](https://github.com/xianyu110/dsh-mneme) - Structured memory engine for DeepSeek Harness. Offline semantic search, entity-attribute-timeline, autoDream self-consolidation, and human-editable Markdown storage.（★ 20；来源：dsh-plugin + deepseek-harness）
...
- [Yan-Zero/dsh-codex](https://github.com/xianyu110/dsh-codex) - Use your ChatGPT subscription in DeepSeek Harness through OpenAI's Codex sign-in flow（★ 16；来源：dsh-plugin + deepseek-harness）
- [ChenRuoT/dsh-sidebar-qa](https://github.com/xianyu110/dsh-sidebar-qa) - 一个基于DSH-better-sidebar的侧边栏提问tab，实现类codex的侧边提问或claude code的/btw功能（★ 15；来源：dsh-plugin + deepseek-harness）
- [ANGELBERRIOS23/conversation-reclaim](https://github.com/xianyu110/conversation-reclaim) - Libera espacio de tus conversaciones de IA (Claude Code, Codex, OpenCode, Antigravity, Command Code) recortando lo anterior a la última compactación — con respaldo previo. Reclaim…（★ 15；来源：deepseek-harness）
- [skymecode/deepseek-harness-for-vscode](https://github.com/xianyu110/deepseek-harness-for-vscode) - deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback!（★ 12；来源：dsh-plugin）[官网](https://marketplace.visualstudio.com/items?itemName=skymecode.deepseek-harness-for-vscode)
- [mesalogo/goodbuddy](https://github.com/xianyu110/goodbuddy) - 未提供项目描述（★ 12；来源：deepseek-harness）
- [xmutfyh/dsh-plugin-writing-guard](https://github.com/xianyu110/dsh-plugin-writing-guard) - Deterministic manuscript integrity guard for AI-assisted academic revision - protects scientific facts, claim strength (causal & evidential), negation, scope and citations during …（★ 8；来源：dsh-plugin + deepseek-harness）
- [Blank-not-black/dsh-Remote](https://github.com/xianyu110/dsh-Remote-blank-not-black) - DSH Remote · 口袋里的 DSH 控制台 会话 · 审批 · 提问 · 文件传输，局域网 / Tailscale 直连 多服务器自动选优，聊天记录离线可看 带 Token 鉴权，数据只在你的设备之间流动 Sessions · approvals · questions · file transfer over LAN / Tailscale. A…（★ 7；来源：dsh-plugin）
