...
- [deepseek-harness](https://github.com/xianyu110/deepseek-harness) - DeepSeek Harness 主项目的代码镜像，包含 Web、TUI、桌面端、插件系统和开发文档。
...
- [dsh-web-ui](https://github.com/xianyu110/dsh-web-ui) - Web UI 插件合集：任务板、Git 图、侧栏、移动端、桌面宠物和 Token 统计。
...
- [dsh-openpencil](https://github.com/xianyu110/dsh-openpencil) - OpenPencil 设计预览和编辑插件。
...
- [deepseek-harness-desktop](https://github.com/xianyu110/deepseek-harness-desktop) - 面向 macOS 和 Windows 的桌面端。
...
- [modlens](https://github.com/xianyu110/modlens) - 图片理解、OCR、版面和语义结构化。
- [dsh-vision-toolkit](https://github.com/xianyu110/dsh-vision-toolkit) - 图片问答、长截图 OCR、UI 还原和 GUI 自动化。
- [modsearch](https://github.com/xianyu110/modsearch) - Web / X 搜索和结构化引用。
...
- [awesome-deepseek-harness-0xsline](https://github.com/xianyu110/awesome-deepseek-harness-0xsline) - DSH 生态、插件和基础设施目录。
...
- [awesome-dsh-plugin-community](https://github.com/xianyu110/awesome-dsh-plugin-community) - 社区维护的插件精选列表。
