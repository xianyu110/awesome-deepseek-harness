...
- [Alishahryar1/free-claude-code](https://github.com/xianyu110/free-claude-code) - Use Claude Code, Codex, Pi, and OpenCode for free (1.3B+ free tokens) from your terminal, app, IDE, or phone like OpenClaw (voice supported + ToS friendly)（★ 46281；来源：deepseek-harness）
- [esengine/DeepSeek-Reasonix](https://github.com/xianyu110/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.（★ 34941；来源：dsh-plugin）[官网](http://reasonix.io/)
...
- [edison7009/EchoBird](https://github.com/xianyu110/EchoBird) - One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI)…（★ 3096；来源：dsh-plugin）[官网](https://echobird.ai/)
- [whiteguo233/OpenBiliClaw](https://github.com/xianyu110/OpenBiliClaw) - 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent…（★ 2957；来源：dsh-plugin + deepseek-harness）[官网](https://whiteguo233.github.io/OpenBiliClaw/)
...
- [qiannianhuanxiang/DSHA](https://github.com/xianyu110/DSHA) - DeepSeek Harness 安卓启动器：内置 proot+Ubuntu，免 ROOT 免 Termux 一键运行 deepseek-harness，多源测速/分步安装/WebUI 预览/设备 Shell 桥接（★ 101；来源：deepseek-harness）
...
- [whitelonng/dshcode](https://github.com/xianyu110/dshcode) - Community desktop companion for DeepSeek Harness — one-click Electron app for macOS and Windows（★ 54；来源：dsh-plugin + deepseek-harness）
- [Ephemeral-AI-Lab/dsh-plugins](https://github.com/xianyu110/dsh-plugins-ephemeral-ai-lab) - Make Deepseek Harness Great（★ 44；来源：dsh-plugin + deepseek-harness）
...
- [skymecode/deepseek-harness-for-vscode](https://github.com/xianyu110/deepseek-harness-for-vscode) - deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback!（★ 36；来源：dsh-plugin + deepseek-harness）[官网](https://marketplace.visualstudio.com/items?itemName=skymecode.deepseek-harness-for-vscode)
- [liguobao/deepseek-harness-remote](https://github.com/xianyu110/deepseek-harness-remote) - 基于 DeepSeek Harness 插件机制的多端远程访问方案，让桌面端与 Android 端安全连接并操作远程 Harness。（A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling desktop and Android…（★ 33；来源：dsh-plugin）[官网](https://dsh.r2049.cn/)
- [SailingLoong/LoongPort](https://github.com/xianyu110/LoongPort) - cc-switch 中转站的专用增强版（cc-switch for API relay providers），免去配置各种 密钥 endpoint 的烦恼。（★ 33；来源：deepseek-harness）[官网](https://loongport.dev/)
